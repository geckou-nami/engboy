...
<template>
  <div 
    :class="[$style.header_container, isTransparent ? $style.hidden : '']"
  >
    <div :class="$style.header_contents">
      ...
      <LinkButton
        :class="[$style.link_button, isTransparent ? $style.hidden : '']"
        :textSize="'var(--fs-button-small)'"
      />
    </div>
  </div>
</template>
...
.logo {
  ...
  width       : var(--logo-size);
  height      : auto;
  margin-block: calc(var(--sp-medium) * 1.5);
